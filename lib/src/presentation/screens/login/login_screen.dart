...
import 'package:cricket_app/src/presentation/screens/login/bloc/bloc.dart';
import 'package:cricket_app/src/presentation/screens/login/widgets/login_form.dart';
import 'package:cricket_app/src/presentation/screens/login/widgets/login_header.dart';
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          GestureDetector(
            ...
            child: const Text(
              'Register',
              style: TextStyle(color: COLOR_CONST.accentTintColor,fontWeight: FontWeight.w500),
            ),
          ),
        ],
      ),
